...
# HeirCon v1.0 training for ATIS and SNIPS
env TRANSFORMERS_OFFLINE=1  python HierConTrainer.py --train_dir ./data/ATIS/experiments/train/clean/train.tsv --val_dir ./data/ATIS/experiments/dev/clean/dev.tsv --intent_count 18 --slots_count 120 --intent_dropout 0.4959487455371492 --slots_dropout 0.4023767420439718 --lr 0.00003436854631596889 --epoch 50 --mode CT --noise_type MC --param_save_dir ./bin/CT_MC_ATIS/ --logging_dir ./logs/CT_MC_ATIS/  --dataset ATIS
env TRANSFORMERS_OFFLINE=1  python HierConTrainer.py --train_dir ./data/ATIS/experiments/train/clean/train.tsv --val_dir ./data/ATIS/experiments/dev/clean/dev.tsv --intent_count 18 --slots_count 120 --intent_dropout 0.4959487455371492 --slots_dropout 0.4023767420439718 --lr 0.00003436854631596889 --epoch 50 --mode CT --noise_type BG --param_save_dir ./bin/CT_BG_ATIS/ --logging_dir ./logs/CT_BG_ATIS/  --dataset ATIS

env TRANSFORMERS_OFFLINE=1  python HierConTrainer.py --train_dir ./data/SNIPS/experiments/train/clean/train.tsv --val_dir ./data/SNIPS/experiments/dev/clean/dev.tsv --intent_count 8 --slots_count 72 --intent_dropout 0.44971200311949866 --slots_dropout 0.31526667279678505 --lr 0.000056253710225502357 --epoch 25 --mode CT --noise_type MC --param_save_dir ./bin/CT_MC_SNIPS/ --logging_dir ./logs/CT_MC_SNIPS/  --dataset SNIPS --warmup 1500
env TRANSFORMERS_OFFLINE=1  python HierConTrainer.py --train_dir ./data/SNIPS/experiments/train/clean/train.tsv --val_dir ./data/SNIPS/experiments/dev/clean/dev.tsv --intent_count 8 --slots_count 72 --intent_dropout 0.44971200311949866 --slots_dropout 0.31526667279678505 --lr 0.000056253710225502357 --epoch 25 --mode CT --noise_type BG --param_save_dir ./bin/CT_BG_SNIPS/ --logging_dir ./logs/CT_BG_SNIPS/  --dataset SNIPS --warmup 1500

# HeirCon v1.0 and Adversarial training MC Noise for ATIS and SNIPS
env TRANSFORMERS_OFFLINE=1  python HierConTrainer.py --train_dir ./data/ATIS/experiments/train/clean/train.tsv --val_dir ./data/ATIS/experiments/dev/clean/dev.tsv --intent_count 18 --slots_count 120 --intent_dropout 0.4959487455371492 --slots_dropout 0.4023767420439718 --lr 0.00003436854631596889 --epoch 45 --mode CT_AT --noise_type MC --param_save_dir ./bin/CT_AT_MC_ATIS/ --logging_dir ./logs/CT_AT_MC_ATIS/  --dataset ATIS
env TRANSFORMERS_OFFLINE=1  python HierConTrainer.py --train_dir ./data/ATIS/experiments/train/clean/train.tsv --val_dir ./data/ATIS/experiments/dev/clean/dev.tsv --intent_count 18 --slots_count 120 --intent_dropout 0.4959487455371492 --slots_dropout 0.4023767420439718 --lr 0.00003436854631596889 --epoch 45 --mode CT_AT --noise_type BG --param_save_dir ./bin/CT_AT_BG_ATIS/ --logging_dir ./logs/CT_AT_BG_ATIS/  --dataset ATIS

env TRANSFORMERS_OFFLINE=1  python HierConTrainer.py --train_dir ./data/SNIPS/experiments/train/clean/train.tsv --val_dir ./data/SNIPS/experiments/dev/clean/dev.tsv --intent_count 18 --slots_count 120 --intent_dropout 0.4959487455371492 --slots_dropout 0.4023767420439718 --lr 0.00003436854631596889 --epoch 45 --mode CT_AT --noise_type MC --param_save_dir ./bin/CT_AT_MC_SNIPS/ --logging_dir ./logs/CT_AT_MC_SNIPS/  --dataset SNIPS
env TRANSFORMERS_OFFLINE=1  python HierConTrainer.py --train_dir ./data/SNIPS/experiments/train/clean/train.tsv --val_dir ./data/SNIPS/experiments/dev/clean/dev.tsv --intent_count 8 --slots_count 72 --intent_dropout 0.4959487455371492 --slots_dropout 0.4023767420439718 --lr 0.00003436854631596889 --epoch 45 --mode CT_AT --noise_type BG --param_save_dir ./bin/CT_AT_BG_SNIPS/ --logging_dir ./logs/CT_AT_BG_SNIPS/  --dataset SNIPS
