...
python IC_NER_Training.py --model_name ./bin/multi_ICPT_CONTRA_5 --train_dir ./data/multi-train.tsv --val_dir ./data/  --exp_name ./logs/multi_IC_NER_ICPT_CONTRA_5 --slots_dropout 0.1949101 --weight_decay 0.0022488 --intent_dropout 0.25895432 --intent_lr 0.00097826 --encoder_lr 0.000014857785 --slots_lr 0.000744823
