...
python IC_NER_Training.py --train_dir ./data/multi-train.tsv --val_dir ./data/  --exp_name jointBert_multi --slots_dropout 0.1949101 --weight_decay 0.0022488 --intent_dropout 0.25895432 --intent_lr 0.00097826 --encoder_lr 0.000074857785 --slots_lr 0.000744823
...
python IC_NER_Training.py --model_name ./bin/multi_ICPT_CONTRA_2 --train_dir ./data/multi-train.tsv --val_dir ./data/  --exp_name ./logs/multi_IC_NER_ICPT_CONTRA_2 --slots_dropout 0.1949101 --weight_decay 0.0022488 --intent_dropout 0.25895432 --intent_lr 0.00097826 --encoder_lr 0.000074857785 --slots_lr 0.000744823
...
python IC_NER_Training.py --model_name ./bin/multi_ICPT_CONTRA_5 --train_dir ./data/multi-train.tsv --val_dir ./data/  --exp_name ./logs/multi_IC_NER_ICPT_CONTRA_5 --slots_dropout 0.1949101 --weight_decay 0.0022488 --intent_dropout 0.25895432 --intent_lr 0.00097826 --encoder_lr 0.000074857785 --slots_lr 0.000744823
...
python IC_NER_Training.py --model_name ./bin/multi_ICPT_CONTRA_1 --train_dir ./data/multi-train.tsv --val_dir ./data/  --exp_name ./logs/multi_IC_NER_ICPT_CONTRA_1 --slots_dropout 0.1949101 --weight_decay 0.0022488 --intent_dropout 0.25895432 --intent_lr 0.00097826 --encoder_lr 0.000074857785 --slots_lr 0.000744823
...
python IC_NER_Training.py --model_name ./bin/multi_ICPT_NXT_0_07 --train_dir ./data/multi-train.tsv --val_dir ./data/  --exp_name ./logs/multi_IC_NER_ICPT_NXT_0_07 --slots_dropout 0.1949101 --weight_decay 0.0022488 --intent_dropout 0.25895432 --intent_lr 0.00097826 --encoder_lr 0.000074857785 --slots_lr 0.000744823
...
python IC_NER_Training.py --model_name ./bin/multi_ICPT_NXT_0_5 --train_dir ./data/multi-train.tsv --val_dir ./data/  --exp_name ./logs/multi_IC_NER_ICPT_NXT_0_5 --slots_dropout 0.1949101 --weight_decay 0.0022488 --intent_dropout 0.25895432 --intent_lr 0.00097826 --encoder_lr 0.000074857785 --slots_lr 0.000744823
